...
/* themes/contrib/cavalla_theme/templates/navigation/pager.html.twig */
class __TwigTemplate_9daa6ce403a90436288f30cf9be10ed8e64b76e4b7f2d878686485bc10f729e1 extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (($context["items"] ?? null)) {
            // line 34
            echo "  <nav class=\"pager my-5\" role=\"navigation\" aria-labelledby=\"";
...
";
    ...
    {
        return "themes/contrib/cavalla_theme/templates/navigation/pager.html.twig";
    }
...
#}
{% if items %}
  <nav class=\"pager my-5\" role=\"navigation\" aria-labelledby=\"{{ heading_id }}\">
    ...
    <ul class=\"pagination m-auto\">
      ...
      {% for key, item in items.pages %}
        <li class=\"pager__item{{ current == key ? ' is-active' : '' }} page-item\">
          {% if current == key %}
...
{% endif %}
", "themes/contrib/cavalla_theme/templates/navigation/pager.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/offapew.com/themes/contrib/cavalla_theme/templates/navigation/pager.html.twig");
    }
}
